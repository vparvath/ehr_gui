# -*- coding: utf-8 -*-
"""
Created on Thu May 10 23:43:26 2018

@author: varun
"""

class Encounter_update:
def __init__(self, top=None):
	...
	self.Label1.place(relx=0.35, rely=0.07, height=21, width=58)
	self.Label1.configure(background="#d9d9d9")
	self.Label1.configure(disabledforeground="#a3a3a3")
	self.Label1.configure(foreground="#000000")
	self.Label1.configure(text='''patient_id''')

	self.Label1_1 = Label(top)
	self.Label1_1.place(relx=0.35, rely=0.16, height=21, width=64)
	...
	self.Label1_1.configure(text='''type''')
	self.Label1_1.configure(width=64)

	self.Label1_1_1 = Label(top)
	self.Label1_1_1.place(relx=0.37, rely=0.25, height=21, width=34)
	...
	self.Label1_1_1.configure(text='''icd''')

	self.Label1_1_1_1 = Label(top)
	self.Label1_1_1_1.place(relx=0.35, rely=0.43, height=21, width=64)
	...
	self.Label1_1_1_1.configure(text='''npi''')
	self.Label1_1_1_1.configure(width=64)

	self.Label1_1_1_1_1 = Label(top)
	self.Label1_1_1_1_1.place(relx=0.33, rely=0.52, height=21, width=74)
	...
	self.Label1_1_1_1_1.configure(text='''encdate''')
	self.Label1_1_1_1_1.configure(width=74)

	self.Label1_1_1_1_1_1_1 = Label(top)
	self.Label1_1_1_1_1_1_1.place(relx=0.37, rely=0.34, height=21, width=34)
	...
	self.Label1_1_1_1_1_1_1.configure(text='''diagnosis''')
	...
	self.Label2.configure(text='''update Encounter details''')
