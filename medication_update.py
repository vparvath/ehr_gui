# -*- coding: utf-8 -*-
"""
Created on Thu May 10 23:41:38 2018

@author: varun
"""

class Medication_update:
    def __init__(self, top=None):
        ...
        self.Entry1_1_1_1_1_1_1_1 = Entry(top)
        self.Entry1_1_1_1_1_1_1_1.place(relx=0.53, rely=0.7, height=20
                , relwidth=0.27)
        self.Entry1_1_1_1_1_1_1_1.configure(background="white")
        self.Entry1_1_1_1_1_1_1_1.configure(disabledforeground="#a3a3a3")
        self.Entry1_1_1_1_1_1_1_1.configure(font=font10)
        self.Entry1_1_1_1_1_1_1_1.configure(foreground="#000000")
        self.Entry1_1_1_1_1_1_1_1.configure(highlightbackground="#d9d9d9")
        self.Entry1_1_1_1_1_1_1_1.configure(highlightcolor="black")
        self.Entry1_1_1_1_1_1_1_1.configure(insertbackground="black")
        self.Entry1_1_1_1_1_1_1_1.configure(selectbackground="#c4c4c4")
        self.Entry1_1_1_1_1_1_1_1.configure(selectforeground="black")
        ...
        self.Label1_1.configure(text='''drug_name''')
        ...
        self.Label1_1_1.configure(text='''dose''')
        ...
        self.Label1_1_1_1.configure(text='''frequency''')
        ...
        self.Label1_1_1_1_1.configure(text='''npi''')
        ...
        self.Label1_1_1_1_1_1.configure(text='''med_cost''')
        ...
        self.Label1_1_1_1_1_1_1.configure(text='''route''')

        self.Label1_1_1_1_1_1_1_1 = Label(top)
        self.Label1_1_1_1_1_1_1_1.place(relx=0.38, rely=0.7, height=21, width=34)

        self.Label1_1_1_1_1_1_1_1.configure(activebackground="#f9f9f9")
        ...
        self.Label1_1_1_1_1_1_1_1.configure(highlightcolor="black")
        self.Label1_1_1_1_1_1_1_1.configure(text='''rxdate''')

        self.Button1 = Button(top)
        self.Button1.place(relx=0.23, rely=0.84, height=34, width=117)
        ...
        self.Button1_1.place(relx=0.63, rely=0.84, height=34, width=117)
        ...
        self.Label2.place(relx=0.03, rely=0.0, height=31, width=174)
        self.Label2.configure(background="#d9d9d9")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(font=font13)
        self.Label2.configure(foreground="#000000")
        self.Label2.configure(text='''Update Medication Details''')
